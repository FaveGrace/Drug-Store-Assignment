...
const lowerCaseDrugs = drugs.map((drug)=>{
...
drugs.forEach((drug)=>{
    console.log(`Drugs ${drug.name}, and Manufacturers ${drug.manufacturer}`)
})

// 5. Return all drugs that require a prescription.
const filteredPrescription = drugs.filter((drug)=>{
...
console.log("Number of Analagesics is:", Analgesic)